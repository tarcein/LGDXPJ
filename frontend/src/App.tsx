...
function App() {
  ...
  const go = (target: Screen) => {
    ...
    const paidFeatureNames: Partial<Record<Screen, string>> = {
      emergency: '긴급 도움 요청', gap: '돌봄 공백 예측', programs: '돌봄 제도 안내', album: '패밀리 앨범',
    }
