...
| OBJ-18               | 인수인계 위치     | `handoff_location`        | 인수인계 확인 시점의 위치 기록                  | FR-024\~025, NFR-024             |
...
| OBJ-30               | 패밀리 앨범      | `family_album`            | 가족 그룹과 자녀별 공유 앨범                   | FR-034, NFR-025                  |
...
### OBJ-18 인수인계 위치 (`handoff_location`)
